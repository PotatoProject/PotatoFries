...
/// [FriesApp] uses this [TextStyle] as its [DefaultTextStyle] to encourage
...
/// [GridPaper].
///
/// The [FriesApp] configures the top-level [Navigator] to search for routes
...
///
/// {@tool snippet}
/// This example shows how to create a [FriesApp] that disables the "debug"
/// banner with a [home] route that will be displayed when the app is launched.
///
/// ![The FriesApp displays a Scaffold ](https://flutter.github.io/assets-for-api-docs/assets/material/basic_material_app.png)
///
/// ```dart
/// FriesApp(
///   home: Scaffold(
...
///
/// {@tool snippet}
/// This example shows how to create a [FriesApp] that uses the [routes]
...
///
/// {@tool snippet}
/// This example shows how to create a [FriesApp] that defines a [theme] that
/// will be used for material widgets in the app.
///
/// ![The FriesApp displays a Scaffold with a dark background and a blue / grey AppBar at the top](https://flutter.github.io/assets-for-api-docs/assets/material/theme_material_app.png)
///
/// ```dart
/// FriesApp(
///   theme: ThemeData(
...
///   home: Scaffold(
///     appBar: AppBar(
///       title: const Text('FriesApp Theme'),
///     ),
///   ),
/// )
/// ```
...
class FriesApp extends StatefulWidget {
  /// Creates a FriesApp.
  ///
  ...
  /// Creates a [FriesApp] that uses the [Router] instead of a [Navigator].
  const FriesApp.router({
    Key? key,
    this.scaffoldMessengerKey,
  ...
  ///    and [darkTheme] in [FriesApp].
  ///  * [ThemeData.brightness], which indicates the [Brightness] of a theme's
  ///    colors.
  final FriesThemeData theme;
  ...
  final FriesThemeData darkTheme;
  ...
  /// ```
  ///
  /// Constructing a [FriesApp] with a `FooLocalizationsDelegate` overrides
  ...
  /// {@template flutter.material.FriesApp.scrollBehavior}
  ...
  @override
  State<FriesApp> createState() => _FriesAppState();

  /// The [HeroController] used for Material page transitions.
  ///
  /// Used by the [FriesApp].
...
class _FriesAppState extends State<FriesApp> {
  ...
  void initState() {
    super.initState();
    _heroController = FriesApp.createMaterialHeroController();
  }
  ...
  Widget _materialBuilder(BuildContext context, Widget? child) {
    ...
    return ScaffoldMessenger(
      ...
      child: AnimatedFriesTheme(
        data: useDarkTheme ? widget.darkTheme : widget.theme,
