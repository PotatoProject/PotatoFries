      ...
      child: Builder(builder: (context) {
        ...
        return MaterialApp(
          ...
          theme: SpicyThemes.light(appInfoProvider.accentDark).copyWith(
            canvasColor: SpicyThemes.light(appInfoProvider.accentLight).scaffoldBackgroundColor,
          ),
          darkTheme: SpicyThemes.dark(appInfoProvider.accentLight).copyWith(
            canvasColor: SpicyThemes.dark(appInfoProvider.accentLight).scaffoldBackgroundColor,
          ),
          home: FriesHome(),
        );
      }),
