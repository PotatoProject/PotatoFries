...
class LocaleStrings {
  ...
  static _$PreferencesLocaleStrings get preferences => _$PreferencesLocaleStrings();
...
class _$LockscreenLocaleStrings {
  ...
  final String pocketPocketJudgeTitle = "lockscreen.pocket.pocket_judge.title".tr();
  final String pocketPocketJudgeDesc = "lockscreen.pocket.pocket_judge.desc".tr();
...
class _$PreferencesLocaleStrings {
  final String colorpickerLightError = "preferences.colorpicker.light_error".tr();
  final String colorpickerDarkError = "preferences.colorpicker.dark_error".tr();
  final String colorpickerLightWarning = "preferences.colorpicker.light_warning".tr();
  final String colorpickerDarkWarning = "preferences.colorpicker.dark_warning".tr();
}
...
class _$QsLocaleStrings {
  ...
  final String colorsQsPanelBgUseFwTitle = "qs.colors.qs_panel_bg_use_fw.title".tr();
  final String colorsQsPanelBgUseFwDesc = "qs.colors.qs_panel_bg_use_fw.desc".tr();
  final String colorsQsPanelBgColorTitle = "qs.colors.qs_panel_bg_color.title".tr();
  final String colorsQsPanelBgColorDesc = "qs.colors.qs_panel_bg_color.desc".tr();
  final String colorsQsPanelBgAlphaTitle = "qs.colors.qs_panel_bg_alpha.title".tr();
  final String colorsQsPanelBgDiscoTitle = "qs.colors.qs_panel_bg_disco.title".tr();
  final String colorsQsPanelBgDiscoDesc = "qs.colors.qs_panel_bg_disco.desc".tr();
}
...
class _$StatusbarLocaleStrings {
  ...
  final String nettrafficNetworkTrafficUnitTypeTitle = "statusbar.nettraffic.network_traffic_unit_type.title".tr();
  final String nettrafficNetworkTrafficUnitTypeV0 = "statusbar.nettraffic.network_traffic_unit_type.v_0".tr();
  final String nettrafficNetworkTrafficUnitTypeV1 = "statusbar.nettraffic.network_traffic_unit_type.v_1".tr();
...
class _$SystemLocaleStrings {
  ...
  final String gesturesThreeFingerGestureTitle = "system.gestures.three_finger_gesture.title".tr();
  final String gesturesThreeFingerGestureDesc = "system.gestures.three_finger_gesture.desc".tr();
  ...
  final String navigationSysuiNavBarHintTitle = "system.navigation.sysui_nav_bar_hint.title".tr();
  final String navigationSysuiNavBarHintDesc = "system.navigation.sysui_nav_bar_hint.desc".tr();
  ...
  final String packagemanagerAllowSignatureFakeTitle = "system.packagemanager.allow_signature_fake.title".tr();
  final String packagemanagerAllowSignatureFakeDesc = "system.packagemanager.allow_signature_fake.desc".tr();
  final String notificationsTitle = "system.notifications.title".tr();
  final String notificationsLessBoringHeadsUpTitle = "system.notifications.less_boring_heads_up.title".tr();
...
class _$ThemesLocaleStrings {
  ...
  final String themesSysuiColorsActiveTitle = "themes.themes.sysui_colors_active.title".tr();
  final String themesSysuiColorsActiveDesc = "themes.themes.sysui_colors_active.desc".tr();
}
