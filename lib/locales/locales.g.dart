...
class _$LocaleEnUS extends _$LocaleBase {
  ...
  Map<String, String> get data => {
    ...
    "lockscreen.albumart.lockscreen_media_metadata.title": "Lockscreen media art",
    "lockscreen.albumart.lockscreen_media_metadata.desc": "Show album art on lockscreen",
    "lockscreen.albumart.lockscreen_media_blur.title": "Lockscreen blur level",
    "lockscreen.albumart.lockscreen_media_blur.desc": "Configure blur intensity of lockscreen media art",
    ...
    "qs.tweaks.qs_show_brightness_slider.desc": "Show a brightness slider in the quick settings panel",
    ...
    "qs.tweaks.qs_tile_title_visibility.desc": "Hide or show title of QS tiles",
    "qs.tweaks.qs_rows_portrait.title": "Tiles rows on portrait",
    "qs.tweaks.qs_columns_portrait.title": "Tiles coilumns on portrait",
    "qs.tweaks.qs_rows_landscape.title": "Tiles rows on landscape",
    "qs.tweaks.qs_columns_landscape.title": "Tiles coilumns on landscape",
    ...
    "statusbar.battery.status_bar_show_battery_percent.title": "Battery Percentage",
    "statusbar.battery.status_bar_show_battery_percent.v_0": "Hidden",
    "statusbar.battery.status_bar_show_battery_percent.v_1": "Inside the icon",
    "statusbar.battery.status_bar_show_battery_percent.v_2": "Next to the icon",
    "statusbar.battery.qs_header_show_battery_percent.title": "QS battery percentage",
    "statusbar.battery.qs_header_show_battery_percent.desc": "Show battery percentage in the QS header instead of estimate",
    ...
    "system.packagemanager.allow_signature_fake.title": "Package signature spoofing",
    "system.packagemanager.allow_signature_fake.desc": "Allow fake signatures (useful for microG)",
    "system.notifications.title": "Notifications",
    "system.notifications.less_boring_heads_up.title": "Less boring heads up",
    "system.notifications.less_boring_heads_up.desc": "Only receive heads up from calling and messaging apps",
    "themes.title": "Themes",
