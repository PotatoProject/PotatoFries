...
class ButtonsDataProvider extends ChangeNotifier {
  ButtonsDataProvider() {
    loadData();
  }
  ...
  void loadData() async {
    for (String categoryKey in appData['buttons_and_gestures'].keys) {
      Map curMap = appData['buttons_and_gestures'][categoryKey];
