...
class AppInfoProvider extends ChangeNotifier {
  ...
  Map<String, Uint8List> _iconPreviews = {};
  ...
  Map<String, Uint8List> get iconPreviews => _iconPreviews;
  ...
  void loadData() async {
    final stuff = await Resources.getIconsWithLabels();
    print(stuff);
